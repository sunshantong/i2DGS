...
def load_data(args):
    if os.path.exists(os.path.join(args.source_path, "sparse")):
        ...
        # Signature: read_tanksandtemples_scene_info(path, eval, white_background, ...).
        scene_info = sceneLoadTypeCallbacks["TanksTemple"](
            args.source_path, args.eval, args.white_background
        )
    else:
