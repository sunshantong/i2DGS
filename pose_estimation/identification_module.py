...
class IdentificationModule(torch.nn.Module):
    def __init__(self, backbone_type: str = "dino",
                 camera_up_output_augmentation: OutputAugmentationTypes = OutputAugmentationTypes.NONE,
                 target_rays_dirs: Optional[torch.Tensor] = None, augmentation_channels: int = 10):
        super().__init__()
        ...
        self.attention = MultiHeadAttention(
            ray_fea_size, img_fea_size, self.backbone_wrapper.img_num_features, 1,learnable_temperature=True
        )
